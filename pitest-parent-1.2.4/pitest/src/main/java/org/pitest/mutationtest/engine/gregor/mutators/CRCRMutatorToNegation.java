...
public class CRCRMutatorToNegation implements MethodMutatorFactory {
    ...
    private final class CRCRMutatorVisitor extends MethodVisitor {
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(CRCRMutatorToNegation.this,
    ...
    public String toString() {
        return "CRCR_MUTATOR_ToNegation";
    }
